...
module.exports = async function(leiam) {
  try{
const leiamnash = (await axios.get(`https://www.pinterest.com/search/pins/?q=${leiam}&rs=typed&term_meta[]=${leiam}%7Ctyped`, {
  headers: {
    ...
    return leiamnash.match(/https:\/\/i\.pinimg\.com\/originals\/[^.]+\.jpg/g);
  } catch(error){}
}