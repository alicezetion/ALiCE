...
bot.react("✅", event.messageID, (err) => {}, true);
  ...
  const leiamC = `${leiamB}/assets/armpit.png`;
  const leiamD = `${leiamB}/cache/armpit1_${event.senderID}.png`;
  const leiamE = `${leiamB}/cache/armpit2_${event.senderID}.png`;
  const leiamF = `${leiamB}/cache/armpit_${event.senderID}.png`;
  const leiamG = [
...
leiamP.composite(leiamN.resize(170, 170), 46, 584).composite(leiamO.resize(220, 220), 316, 204);
