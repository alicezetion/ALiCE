...
bot.react("✅", event.messageID, (err) => {}, true);
  ...
  const leiamC = `${leiamB}/assets/fuck.png`;
  const leiamD = `${leiamB}/cache/fuck1_${event.senderID}.png`;
  const leiamE = `${leiamB}/cache/fuck2_${event.senderID}.png`;
  const leiamF = `${leiamB}/cache/fuck_${event.senderID}.png`;
  const leiamG = [
...
leiamP.composite(leiamN.resize(180, 180), 190, 200).composite(leiamO.resize(180, 180), 390, 200);
