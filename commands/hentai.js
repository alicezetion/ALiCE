...
try {
 ...
 message(await font(language.request.replace("{0}", "random hentai video from internet")), "✅");
  const leiamX = [ "hentai", "hanime", "hentaiheaven", "hentaimama", "hentai release", "hentai uncensored", "hentai ugly bustard", "hentai ntr", "hentai milf" ]
...
const leiamC = `${cache}hentai_${event.senderID}.mp4`;
