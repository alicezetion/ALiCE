...
bot.react("✅", event.messageID, (err) => {}, true);
  ...
  const leiamC = `${leiamB}/assets/blowjob.png`;
  const leiamD = `${leiamB}/cache/blowjob1_${event.senderID}.png`;
  const leiamE = `${leiamB}/cache/blowjob2_${event.senderID}.png`;
  const leiamF = `${leiamB}/cache/blowjob_${event.senderID}.png`;
  const leiamG = [
...
leiamP.resize(500, 500).composite(leiamN.resize(100, 100), 360, 28).composite(leiamO.resize(70, 70), 131, 165);
