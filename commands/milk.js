...
bot.react("✅", event.messageID, (err) => {}, true);
  ...
  const leiamC = `${leiamB}/assets/milk.png`;
  const leiamD = `${leiamB}/cache/milk1_${event.senderID}.png`;
  const leiamE = `${leiamB}/cache/milk2_${event.senderID}.png`;
  const leiamF = `${leiamB}/cache/milk_${event.senderID}.png`;
  const leiamG = [
...
leiamP.composite(leiamO.resize(185,185), 190, 10).composite(leiamN.resize(165, 165), 285, 240);
