...
bot.react("✅", event.messageID, (err) => {}, true);
  ...
  const leiamC = `${leiamB}/assets/mommy.png`;
  const leiamD = `${leiamB}/cache/elf1_${event.senderID}.png`;
  const leiamE = `${leiamB}/cache/elf2_${event.senderID}.png`;
  const leiamF = `${leiamB}/cache/elf_${event.senderID}.png`;
  const leiamG = [
...
leiamP.composite(leiamN.resize(150, 150), 56, 164).composite(leiamO.resize(150, 150), 380, 190)
