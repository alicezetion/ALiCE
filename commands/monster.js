...
async function leiamnash(leiam, nash) {
  ...
  const jimp = require("jimp");
        let base = await jimp.read(path.resolve(__dirname, "..", "alice/assets/bed.png"));
        ...
        base.composite(image1, 25, 100);
        base.composite(image1, 25, 300);
        base.composite(image3, 53, 450);
        base.composite(image2, 53, 575);
