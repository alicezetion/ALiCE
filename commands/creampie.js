...
bot.react("✅", event.messageID, (err) => {}, true);
  ...
  const leiamC = `${leiamB}/assets/creampie.png`;
  const leiamD = `${leiamB}/cache/creampie1_${event.senderID}.png`;
  const leiamE = `${leiamB}/cache/creampie2_${event.senderID}.png`;
  const leiamF = `${leiamB}/cache/creampie_${event.senderID}.png`;
  const leiamG = [
...
leiamP.composite(leiamN.resize(1, 1), 1, 1).composite(leiamO.resize(150, 150), 460, 20);
